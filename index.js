...
function indekseGoreFenomen(fenomenler,fenomenSayilari) {

  return fenomenSayilari + ". indekste bulunan fenomen:" + " " + fenomenler[fenomenSayilari].profile
}
...
function profilListesi(yeniFenomen) {
  const profilDizisi=yeniFenomen;
  const kopyaDizi=[...profilDizisi];
  for (let i=0; i<kopyaDizi.length; i++) {
    kopyaDizi[i] = kopyaDizi[i].profile
  }
  return kopyaDizi
}
